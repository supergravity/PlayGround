...
CMSSW_BASE:=/wk_cms2/tzlin/PlayGround/TopQuarkAnalysis/CMSSW_8_0_26_patch1
...
CMSSW_BASE_FULL_RELEASE:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_8_0_26
CMSSW_BINDIR:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_8_0_26/bin/slc6_amd64_gcc530
...
export CCACHE_BASEDIR:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw-patch/CMSSW_8_0_26_patch1
endif
...
LOCALTOP:=/wk_cms2/tzlin/PlayGround/TopQuarkAnalysis/CMSSW_8_0_26_patch1
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/wk_cms2/tzlin/PlayGround/TopQuarkAnalysis/CMSSW_8_0_26_patch1
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw-patch/CMSSW_8_0_26_patch1
SCRAM_INTlog:=logs
...
SCRAM_SOURCEDIR:=src
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_8_0_26_patch1:slc6_amd64_gcc530:V2_2_7_pre1:SRT_
SCRAM_CONFIGCHKSUM:=V05-05-11
SCRAM_LOOKUPDB_WRITE:=/cvmfs/cms.cern.ch
SCRAM_PROJECTVERSION:=CMSSW_8_0_26_patch1
